...
Hooks.addAction('pp.ready', function() {
  return $('.Gallery__item').on('click', function(e) {
    var $el;
    e.preventDefault();
    $el = $(this);
